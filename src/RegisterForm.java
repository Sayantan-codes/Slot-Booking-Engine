...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void jLabel3minimiseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3minimiseMouseClicked
        this.setState(JFrame.ICONIFIED);
    }//GEN-LAST:event_jLabel3minimiseMouseClicked
    ...
    private void jButton_Register_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Register_ActionPerformed
        ...
        if(fname.equals("")||(lname.equals(""))||(uname.equals(""))||(pass.equals("")))
            JOptionPane.showMessageDialog(null,"* Marks cannot be left empty");
        ...
        String query = "INSERT INTO details (first_n, last_n, name_u, pass_u)VALUES(?,?,?,?)";
    ...
    public boolean checkUsername(String username)
    {
        ...
        ResultSet rs;
        String query ="select * from details where name_u =?";
        try {
            ps=(PreparedStatement) MyConnection.getConnection().prepareStatement(query);
    ...
    private javax.swing.JLabel jLabel3minimise;
